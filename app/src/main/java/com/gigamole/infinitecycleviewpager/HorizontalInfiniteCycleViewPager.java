...
public class HorizontalInfiniteCycleViewPager extends ViewPager implements ViewPageable {
	...
	public void setMinPageScale(final float minPageScale) {
		if (mInfiniteCycleManager != null)
			mInfiniteCycleManager.setMinPageScale(minPageScale);
	}
	...
	public void setMaxPageScale(final float maxPageScale) {
		if (mInfiniteCycleManager != null)
			mInfiniteCycleManager.setMaxPageScale(maxPageScale);
	}
	...
	public void setMediumScaled(final boolean mediumScaled) {
		if (mInfiniteCycleManager != null)
			mInfiniteCycleManager.setMediumScaled(mediumScaled);
	}
	...
	public void setScrollDuration(final int scrollDuration) {
		if (mInfiniteCycleManager != null)
			mInfiniteCycleManager.setScrollDuration(scrollDuration);
	}
	...
	public void setInterpolator(final Interpolator interpolator) {
		if (mInfiniteCycleManager != null)
			mInfiniteCycleManager.setInterpolator(interpolator);
	}
	...
	public OnInfiniteCyclePageTransformListener getOnInfiniteCyclePageTransformListener() {
		return mInfiniteCycleManager == null ? null : mInfiniteCycleManager.getOnInfiniteCyclePageTransformListener();
	}
	...
	public void setPageTransformer(final boolean reverseDrawingOrder, final PageTransformer transformer) {
		super.setPageTransformer(false,
				mInfiniteCycleManager == null ? transformer : mInfiniteCycleManager.getInfinityCyclePageTransformer());
	}
	...
	public int getRealItem() {
		return mInfiniteCycleManager == null ? getCurrentItem() : mInfiniteCycleManager.getRealItem();
	}

	public int getState() {
		return mInfiniteCycleManager == null ? ViewPager.SCROLL_STATE_IDLE : mInfiniteCycleManager.getState();
	}

	public void notifyDataSetChanged() {
		if (mInfiniteCycleManager != null)
			mInfiniteCycleManager.notifyDataSetChanged();
	}

	public void invalidateTransformer() {
		if (mInfiniteCycleManager != null)
			mInfiniteCycleManager.invalidateTransformer();
	}

	public void postInvalidateTransformer() {
		if (mInfiniteCycleManager != null)
			mInfiniteCycleManager.postInvalidateTransformer();
	}
